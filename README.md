.# FinTech-Journey-2026-300-days-
Tracking my progress in Python, Chart Analysis, and ACCA prep starting March 8th."
## Day 1: March 8, 2026
Official start of the 300-day FinTech roadmap. Today's focus: Setting up the digital workspace and starting Python basics.

## Day 2: March 9, 2026
**Focus:** Variables, Math Operations (+), and String Concatenation.
...
## Day 3: March 10, 2026
Focus: Subtraction (-), Financial Logic, and Net Profit Calculation.
Key Learnings:
Math Subtraction: Applied the - operator to simulate real-world commerce scenarios like discounts and bank withdrawals.
Financial Logic: Built a Net Profit Tracker that subtracts brokerage fees and taxes from gross profit—essential for trading.
...
- Introduced the .get() method to safely retrieve dictionary values.
